Class constructor($transporter : Object)
	...
	This:C1470.delimiter:=This:C1470._transporter.getDelimiter()
	
	This:C1470.lvlMin:=1
	
Function initList->$listRef : Integer
	This:C1470._count:=cs:C1710.Counter.new()
	
	// List of subscribes mailboxes returned by the server
	This:C1470.subscribed:=This:C1470._transporter.getBoxList(New object:C1471("isSubscribed"; True:C214))
	If (This:C1470.subscribed=Null:C1517)
		This:C1470.subscribed:=New collection:C1472
	End if 
	...
	APPEND TO LIST:C376($listRef; "Subscribed"; -1; This:C1470.subscribedList(); True:C214)
	
	APPEND TO LIST:C376($listRef; "MailBox"; -2; This:C1470.createList(This:C1470.lvlMin); True:C214)
	
	// Creation of a list to display the subscribe mailbox names in a hierarchical list
Function subscribedList->$listRef : Integer
	var $count : Integer
	var $names : Collection
	
	$listRef:=New list:C375
	
	For ($count; 0; This:C1470.subscribed.length-1)
		$names:=Split string:C1554(This:C1470.subscribed[$count].name; This:C1470.delimiter)
		
		APPEND TO LIST:C376($listRef; $names[$names.length-1]; This:C1470._UID.inc())
		This:C1470.subscribed[$count].listId:=This:C1470._UID.value(); 
	End for 
...
Function createList($lvl : Integer)->$listRef : Integer
	...
	$names:=Split string:C1554(This:C1470._mailboxes[This:C1470._count.value()].name; This:C1470.delimiter)
...
Function search($listId : Integer)->$mailbox : Object
	...
	// search by listId in the _mailboxes collection
	$mailboxes:=This:C1470._mailboxes.query("listId=:1"; $listId)
	
	If ($mailboxes.length=0)
		// if not present in mailboxes list, search by listId in the subscribed mailbox collection
		$mailboxes:=This:C1470.subscribed.query("listId=:1"; $listId)
	End if 
	If ($mailboxes.length=0)
		$mailbox:=Null:C1517
	Else 
